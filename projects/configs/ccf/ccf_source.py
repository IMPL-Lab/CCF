...
train_pipeline = [
    ...
    dict(
        type='MultiModalGridMask',
        use_h=True,  # use horizontal direction mask
        use_w=True,  # use vertical direction mask
        max_iter=num_epochs * num_iters_per_epoch,
        rotate=1,
        offset=False,
        ratio=0.3,  # mask length ratio
        mode='01',
        consistent=False,
        prob=0.7,
        # fixed_prob=True,
